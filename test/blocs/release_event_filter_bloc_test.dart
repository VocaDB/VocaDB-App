...
main() {
  ReleaseEventFilterBloc bloc;

  setUp(() {
    bloc = ReleaseEventFilterBloc();
  });

  test('should update category', () async {
    bloc.updateCategory('Concert');

    await expectLater(bloc.category$, emits('Concert'));

    expect(bloc.category, equals('Concert'));
  });
  ...
  test('should return params correctly', () {
    ...
    expect(params.containsKey('releaseEventTypes'), isFalse);
    ...
    expect(params.containsKey('category'), isTrue);
    expect(params['category'], equals('Concert'));
