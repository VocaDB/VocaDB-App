...
class SongTile extends StatelessWidget {
  ...
  const SongTile({Key key, this.id, this.name, this.artist, this.imageUrl}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return ListTile(
          onTap: () {
            Navigator.push(context, MaterialPageRoute(builder: (context) => SongDetailPage(thumbUrl: this.imageUrl, tag: tag)));
          },
          leading: SizedBox(
            width: 50,
            height: 50,
