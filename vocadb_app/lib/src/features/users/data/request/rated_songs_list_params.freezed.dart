...
class _$_RatedSongsListParams implements _RatedSongsListParams {
  ...
  @override
  String toString() {
    return 'RatedSongsListParams(query: $query, tagId: $tagId, artistId: $artistId, rating: $rating, start: $start, maxResults: $maxResults, sort: $sort, fields: $fields, lang: $lang)';
  }
